...
def CategoryBuilder(X: pd.DataFrame,
                    category_colname: str,
                    cutoffs: str,
                    labels: str,
                    categoryType = 'percentile',
                    categoryTitle = 'categories') -> None: 
    ...
    if categoryType == 'percentile':
        pass

def FactorBuilder(  X: pd.DataFrame,
                    returns_colname: str,
                    risk_colname: str,
                    category_colname: str) -> float:
